...
public class ShapeDataDrawer : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if(ShapeDataInstance.board != null && ShapeDataInstance.columns > 0 &&
    ...
    private void DrawColumnsFields()
    {
    ...
    private void DrawBoardTable()
    {
        ...
        var rowStye = new GUIStyle();
        rowStye.fixedHeight = 25;
        rowStye.alignment = TextAnchor.MiddleCenter;
        ...
        for(var row = 0; row < ShapeDataInstance.rows; row++)
        {
            ...
            {
                EditorGUILayout.BeginHorizontal(rowStye);
